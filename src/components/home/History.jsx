...
const History = () => {
    return (
        <section id="historia" className="py-24 bg-stone-100 relative overflow-hidden">
            {/* Decorative Elements */}
            ...
            <div className="container mx-auto px-4">
                <div className="flex flex-col md:flex-row items-center gap-16">
                    ...
                    >
                        ...
                        <h2 className="font-mexican text-4xl md:text-6xl text-gray-900 mb-6 leading-tight">
                        ...
                        <div className="grid grid-cols-3 gap-4 text-center border-t border-gray-300 pt-6">
                            <div>
                                <h3 className="font-mexican text-3xl text-red-700">100%</h3>
                                <p className="text-gray-500 text-xs font-bold uppercase tracking-wider">Fresco</p>
                            </div>
                            <div>
                                <h3 className="font-mexican text-3xl text-red-700">20+</h3>
                                <p className="text-gray-500 text-xs font-bold uppercase tracking-wider">Salsas</p>
                            </div>
                            <div>
                                <h3 className="font-mexican text-3xl text-red-700">4.9</h3>
